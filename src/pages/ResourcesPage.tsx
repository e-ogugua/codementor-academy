...
import { ExternalLink, BookOpen, Code, Users, FileText, Bookmark, BookmarkCheck } from 'lucide-react';
...
export function ResourcesPage() {
  ...
  const categories = ['All', ...Array.from(new Set(resourcesData.map((r: Resource) => r.category)))];
  ...
  const getIcon = (category: string) => {
    switch (category) {
      ...
      case 'Cheat Sheets': return FileText;
      case 'Tutorials': return BookOpen;
      case 'Communities': return Users;
      case 'Career Tips': return ExternalLink;
      case 'Developer Tools': return Code;
      case 'Code Challenges': return ExternalLink;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {categories.slice(1).map((category: string, index: number) => {
          const categoryResources = filteredResources.filter((r: Resource) => r.category === category);
