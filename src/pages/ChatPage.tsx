...
import { BookOpen, Brain, Lightbulb, Send, TrendingUp, User } from 'lucide-react';
...
const aiResponses: Record<string, string[]> = {
  ...
  react: [
    'React is an excellent JavaScript library for building user interfaces. Have you tried creating components yet?',
    "React makes building interactive UIs straightforward. What's your favorite React hook?",
  ],
  javascript: [
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: 'ai',
      content:
        "Hi! I'm Alex, your AI coding mentor. I'm here to help you learn and grow as a developer. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
