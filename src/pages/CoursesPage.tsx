      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          ...
          <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
            Bite-sized, hands-on coding lessons to build your skills step by step. Each includes
            objectives, explanations, code examples, and a "Try It Yourself" section.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className='text-gray-400'>
            Complete steps to unlock premium features and advanced content!
          </p>
        </motion.div>
        ...
        {currentStep >= 1 && (
          ...
          >
            <h3 className='text-xl font-bold text-white mb-2'>Premium Features Available</h3>
            <p className='text-gray-300 mb-4'>
              You've completed basic lessons. Access advanced topics and personalized mentoring.
            </p>
            <motion.button
