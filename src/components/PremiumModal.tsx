      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 mb-4">Your {selectedPlan} plan is now active. Enjoy unlimited access to all premium features!</p>
        ...
        >
          ...
          >
            ...
            <div className="text-center text-gray-400 text-sm">
              <p>🚀 Cancel anytime. No hidden fees. Start your premium journey today!</p>
            </div>
          </motion.div>
        </motion.div>
      )}
