...
import { X, Play, Code, RotateCcw } from 'lucide-react';
          ...
          >
            ...
            <div className="mt-4 p-3 bg-blue-900/20 rounded-lg border border-blue-500/30">
              <p className="text-blue-200 text-sm">
                💡 <strong>Tip:</strong> This is a basic playground. In the full app, you'll have access to advanced features like syntax highlighting, error checking, and real-time collaboration!
              </p>
            </div>
          </motion.div>
        </motion.div>
