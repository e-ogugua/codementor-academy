...
import { Send, Bot, User, Code, BookOpen, Lightbulb } from 'lucide-react';
...
export function ChatPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: "Hi! I'm Alex, your AI mentor. I'm here to help you master React development. What would you like to learn today?",
      sender: 'alex',
      timestamp: new Date(),
    }
  ]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-gray-300">Your AI mentor is ready to help you master React development</p>
        </motion.div>
